...
echo "This script uninstalls the 'fmt-center' utility and its man page."
echo
...
BINARY_PATH="$INSTALL_DIR/fmt-center"
MAN_PATH="$MAN_DIR/fmt-center.1"
...
echo
echo "fmt-center uninstall complete."
