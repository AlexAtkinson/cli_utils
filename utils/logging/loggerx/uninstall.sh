...
echo "This script uninstalls the 'loggerx' utility and its man page."
echo
...
BINARY_PATH="$INSTALL_DIR/loggerx"
MAN_PATH="$MAN_DIR/loggerx.1"
...
echo
echo "loggerx uninstall complete."
