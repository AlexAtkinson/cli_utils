...
echo "This script uninstalls the 'md-add-copyright' utility and its man page."
echo
...
read -r -p "Remove script from (default: $DEFAULT_INSTALL_DIR): " USER_INSTALL_DIR
...
SCRIPT_PATH="$INSTALL_DIR/md-add-copyright"
MAN_PATH="$MAN_DIR/md-add-copyright.1"
...
if [[ -e "$SCRIPT_PATH" ]]; then
  ...
  echo "Script not found (already absent): $SCRIPT_PATH"
fi
...
echo
echo "md-add-copyright uninstall complete."
